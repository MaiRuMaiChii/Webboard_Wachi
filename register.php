...
<body>
    ...
    <form>
        <table style="border: 2px solid black; width: 30%;" align="center">
            <tr><td colspan="2" style="background-color: rgb(76, 194, 241);">กรอกข้อมูล</td></tr>
            <tr><td>ชื่อบัญชี : </td><td><input type="text" name="account" size="35" required></td></tr>
            <tr><td>รหัสผ่าน : </td><td><input type="password" name="pwd" size="35" required></td></tr>
            <tr><td>ชื่อ-นามสกุล : </td><td><input type="text" name="name" size="35" required></td></tr>
            <tr><td>เพศ :</td>
            <td>
                <input type="radio" name="gender" value="m">ชาย  <br>
                <input type="radio" name="gender" value="fm">หญิง <br>
                <input type="radio" name="gender" value="a">อื่นๆ
            </td></tr>
